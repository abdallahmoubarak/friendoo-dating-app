const profilePage = (
  user = JSON.parse(localStorage.getItem("friendooUser")),
) => {
  return `<div class='form'>
      ...
      <div class='input-section-container padding-top-bottom'> 
        ${
      ...
      <button class='sign-btn active-btn' id='save-btn'>Save</button>
    </div>`;
};
